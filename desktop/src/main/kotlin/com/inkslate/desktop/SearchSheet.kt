...
fun SearchSheet(
    ...
    // The sheet exists to be typed into, so it arrives with the caret already there.
        ...
        Column(Modifier.fillMaxWidth().heightIn(max = 560.dp)) {
            ...
            if (searching) {
                LinearProgressIndicator(
                    progress = { if (pageCount > 0) (progressPage + 1f) / pageCount else 0f },
                ...
                hits.isEmpty() && !searching -> Box(
                    ...
                    itemsIndexed(hits) { _, hit ->
                        Column(
                            ...
                            Text(hit.snippet, style = MaterialTheme.typography.bodySmall, maxLines = 2)
                        }
                    }
                }
            }
